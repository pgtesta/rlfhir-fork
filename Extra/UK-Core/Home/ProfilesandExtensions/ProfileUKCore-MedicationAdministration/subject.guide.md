...
Within a FHIR Messaging or FHIR Document implementation, include a <a href="https://simplifier.net/guide/UKCoreImplementationGuide0.3.0-STU1/Home/ProfilesandExtensions/ProfileUKCore-Patient">ProfileUKCore-Patient</a> resource within the Bundle with at least the minimum dataset populated as defined within the UK Core standard. The `reference` points to the resource in the Bundle.

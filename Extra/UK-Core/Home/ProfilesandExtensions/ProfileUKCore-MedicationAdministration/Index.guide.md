...
<div id="Examples" class="tabcontent">
 ...
 {{link:UKCore-MedicationAdministration-TimoptolEyeDrops-Example}}  
</div>
</div>
...
- to record and/or share inpatient or outpatient non-immunization administrations. For immunisations use the [UKCore Immunization](ProfileUKCore-Immunization) resource.

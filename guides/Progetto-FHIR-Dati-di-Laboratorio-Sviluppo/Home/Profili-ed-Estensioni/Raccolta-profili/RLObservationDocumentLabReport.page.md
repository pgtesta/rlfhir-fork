...
Il profilo RLObservationLabReport è stato strutturato a partire dalla risorsa generica FHIR [Observation](http://hl7.org/fhir/R4/observation.html) per contenere le rilevazioni cliniche per il referto di laboratorio.
...
|---|---|---|
| observation status | Stato dell'observation  | La codifica è definita dal Valueset (http://hl7.org/fhir/ValueSet/observation-status)  |
...
| observation category| Codici per la categoria di observation | La codifica è definita dal Valueset (http://hl7.org/fhir/ValueSet/observation-category)  |

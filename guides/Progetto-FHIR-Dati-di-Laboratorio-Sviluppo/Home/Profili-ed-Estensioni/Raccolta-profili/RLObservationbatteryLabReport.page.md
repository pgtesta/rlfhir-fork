...
|---|---|---|
| code  | Valueset contenente i codici LOINC per la specialità di laboratorio. | La codifica è definita dal ValueSet {{link:http://hl7.it/fhir/lab-report/ValueSet/sezione-referto-laboratorio}} |
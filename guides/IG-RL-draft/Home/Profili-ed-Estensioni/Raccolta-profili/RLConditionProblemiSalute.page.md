...
| Severity | Codice e descrizione del livello di gravità della cronicità | La codifica è definita dal ValueSet https://fhir.siss.regione.lombardia.it/CodeSystem/GPC-LivelloGravita |
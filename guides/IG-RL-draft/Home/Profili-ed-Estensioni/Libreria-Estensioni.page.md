    ...
    <table style="width: fit-content">
      ...
      <tbody id="myTable">
        <tr>
          ...
          <td>Organization</td>
          <td>
            ASST sotto la quale l'ente eroga servizi sociosanitari sul territorio di
            competenza
          </td>
          <td>
        ...
        <tr>
          ...
          <td>Address</td>
          <td>
            Codice del Distretto di appartenenza del comune a cui fa riferimento
            l'indirizzo
          </td>
          <td>
        ...
        <tr>
          ...
          <td>DeviceRequest</td>
          <td>
            Flag riguardo la necessità di una prescrizione elettronica per il
            paziente
          </td>
          <td>
        ...
        <tr>
          ...
          <td>Encounter</td>
          <td>
            Codice e descrizione della tipologia del bisogno rilevata al cittadino
          </td>
          <td>
        ...
        <tr>
          ...
          <td>Patient</td>
          <td>
            Codice della responsabilità genitoriale nei confronti dell'assistito se
            minorenne
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            Numero di identificazione dell'istituzione indicata sulla tessera TEAM
          </td>
          <td>
        ...
        <tr>
          ...
          <td>Procedure</td>
          <td>
            Data della presa in carico del paziente da parte dell'Ente Erogatore
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            Riferimento all'esito della valutazione (semplice o multidimensionale)
        ...
        <tr>
          ...
          <td>
            Nel caso in cui il codice del servizio sociosanitario (campo code) sia
            "C-DOM" questo campo contiene la causale di dimissione del paziente dal
        ...
        <tr>
          ...
          <td>
            Nel caso in cui il codice del servizio sociosanitario (campo code) sia
            "C-DOM" questo campo contiene la data di dimissione del paziente dal
            ricovero domiciliare
          </td>
          <td>
        ...
        <tr>
          ...
          <td>ServiceRequest</td>
          <td>
            Dettagli riguardo le modalità di prenotazione del servizio
            sociosanitario
          </td>
          <td>
        ...
        <tr>
          ...
          <td>ServiceRequest</td>
          <td>
            Codice del soggetto che ha proposto la presa in carico dell'assistito
          </td>
          <td>
        ...
        <tr>
          ...
          <td>ServiceRequest</td>
          <td>
            Ulteriori dettagli riguardo la prestazione specialistica e/o diagnostica
            da erogare
          </td>
          <td>

...
Il profilo RLObservationCoreStoriaClinica è stato strutturato a partire dalla risorsa generica FHIR [Location](http://hl7.org/fhir/R4/observation.html) volto a contenere le informazioni relative alla storia clinica del paziente in Regione Lombardia.
